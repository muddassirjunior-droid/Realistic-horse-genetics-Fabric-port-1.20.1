...
import sekelsta.horse_colors.config.ConfigSpec;
import sekelsta.horse_colors.config.ConfigSpec.BooleanValue;
import sekelsta.horse_colors.config.ConfigSpec.ConfigValue;
import sekelsta.horse_colors.config.ConfigSpec.IntValue;
import sekelsta.horse_colors.config.ConfigSpec.DoubleValue;
import sekelsta.horse_colors.config.ConfigSpec.ListValue;
...
public class HorseConfig
{
    ...
    public static class Common {
        ...
        public static ListValue<String> equineFoods;

        Common(final ConfigSpec.Builder builder) {
            ...
            equineFoods = builder
                    ...
                    .defineListAllowEmpty("equineFoods", DEFAULT_EQUINE_FOODS, o -> o instanceof String);
    ...
    public static class Growth {
        ...
        Growth(final ConfigSpec.Builder builder) {
    ...
    public static class Breeding {
        ...
        public static ListValue<String> horseBreedingFoods;
        public static ListValue<String> donkeyBreedingFoods;

        public Breeding(final ConfigSpec.Builder builder) {
            ...
            horseBreedingFoods = builder
                    ...
                    .defineListAllowEmpty("horseBreedingFoods", DEFAULT_HORSE_BREEDABLE, o -> o instanceof String);
            ...
            donkeyBreedingFoods = builder
                    ...
                    .defineListAllowEmpty("donkeyBreedingFoods", DEFAULT_DONKEY_BREEDABLE, o -> o instanceof String);
    ...
    public static class Genetics {
        ...
        Genetics(final ConfigSpec.Builder builder) {
    ...
    public static class Spawn {
        ...
        Spawn(final ConfigSpec.Builder builder) {
    ...
    public static boolean shouldConvert(Entity entity) {
        ...
        return (c == HorseEntity.class && SPAWN.convertVanillaHorses.get())
            || (c == DonkeyEntity.class && SPAWN.convertVanillaDonkeys.get())
            || (c == MuleEntity.class && SPAWN.convertVanillaMules.get());
    }
}
