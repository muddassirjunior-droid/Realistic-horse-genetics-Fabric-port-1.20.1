...
public class Util {
    public static boolean horseCanMate(AbstractHorseEntity horse) {
        ...
        return !horse.hasPassengers() && !horse.hasVehicle() && !horse.isBaby() && horse.getHealth() >= horse.getMaxHealth() && horse.isInLove();
    }

    public static String translate(String in) {
        return Text.translatable(HorseColors.MOD_ID + "." + in).getString();
    }
